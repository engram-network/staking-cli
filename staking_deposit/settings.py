...
EngramSetting = BaseChainSetting(
    NETWORK_NAME=ENGRAM, GENESIS_FORK_VERSION=bytes.fromhex('10000131'),
    GENESIS_VALIDATORS_ROOT=bytes.fromhex('c78d775f2899f59c64c705ebb6f40aeff0d5ba28f37f46158d973cb5fb1e2e15'))
